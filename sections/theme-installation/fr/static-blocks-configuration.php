...
<ol class="index-list"> 
	...
	<li>Cliquez sur le bouton "Add New block" du coin droit pour ajouter un nouveau bloc.<figure class="img-polaroid"><img src="img/magento/pages-setting-5.jpg" alt="" /></figure></li>
