...
<p class="alert alert-info"><span>The source files with the static blocks code are stored in the "<b>sources\demo\static_blocks\</b>" directory of the template package. </span></p>
