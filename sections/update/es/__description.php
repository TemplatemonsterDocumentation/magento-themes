...
<p>Regularly updating <strong>Magetique Template</strong> brings you not only the newest features, but also security
    fixes, which is highly important for your Magento store's safety.</p>

<div class="alert alert-danger">
  <p><strong>Attention!</strong> Please make sure to create a full backup of your Magento store files. Any manual
      changes your performed to the theme files will be replace by the update. </p>
</div>

<p>If you want to customize theme files and still be able to receive updates please create a child theme and perform
...
<article id="manual-update">
    ...
    <p><b>1.</b> To install Magetique theme update upload updated theme files to your hosting server. Upload the
        <b>app</b>
...
<div class="alert alert-warning">
    <p>In case you have any issues with modules or widgets after the update try to recreate widgets and module
