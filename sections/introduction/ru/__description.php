...
<article id="updatabletheme">
    <h3>Тема Ketty</h3>
    <p>Мы рады представить вашему вниманию новый обновлённый дизайн и функционал данной премиальной темы. </p>
   <h4>Changelog</h4>
    <h6>Major Update:</h6>
    <ul class="line-list">
    ...
    <p>В папке <strong>magento_1.9x_v.1.0</strong> находится тема под версию Magento 1.9.1.0 на базе стандартной темы. Этот дизайн был доступен для покупки ранее.</p>
    <p>В папке <strong>magento_1.9x_v.2.0</strong> находится обновлённая тема под версию Magento 1.9.2.1 на базе RWD темы. Данный дизайн содержит обновлённый дизайн подстраниц и функционал Configurable swatches.</p>
    <div class="alert alert-warning">
        <p>Старая и новая тема несовместимы. Не пытайтесь залить новую тему поверх старой.</p>
    </div>
    <p>Как настроить вывод страниц вы можете прочесть в разделах <strong>Установка темы Magento</strong> и <strong>Настройки уникальной темы</strong>.</p>
</article>
    ...
    <ul class="files_structure">
        ...
        <li>
            <dl class="inline-term">
                ...
                <dd> содержит файлы старой версии шаблона на базе <strong> base -> default</strong> темы Magento 1.9.x.</dd>
            </dl>
            <ul>
                <li>
                    <dl class="inline-term">
        ...
        <li>
            <dl class="inline-term">
                ...
                <dd> содержит файлы новой версии шаблона на базе <strong> RWD -> default</strong> темы Magento 1.9.x.</dd>
            </dl>
            <ul>                
                <li>
                    <dl class="inline-term">
                        <dt><i class="fa fa-folder"></i> <strong>newsletter</strong></dt>
                        <dd> содержит файлы и папки шаблона почтовой рассылки, специально созданного под дизайн данного шаблона.</dd>
                    </dl>            
                </li>
                <li>
                    <dl class="inline-term">
