...
<p>The following resources will help you to become a true Magento professional:</p>
        ...
        <h4>Help &amp; Support</h4>
        <div align="justify">In case of any difficulties with the<strong> Magetique</strong> template or any other products of <a href="https://www.templatemonster.com/?utm_expid=2187874-88.E4frEvLdRUiVnTFNAZQ_cw.0">TemplateMonster.com</a> please contact our 24/7 support team for assistance.        </div>
        <ul class="marked-list">
    <li><a href="http://chat.template-help.com/" target="_blank">Live chat</a></li>
        ...
        <div align="justify">Some countries have issues connecting to Google servers. This can cause issues loading Google Fonts from Google CDN. To resolve these issues please do the following: </div>
        <ol class="index-list"> 
