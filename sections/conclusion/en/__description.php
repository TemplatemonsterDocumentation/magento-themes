<h2 class="item7"><i class="icon-question-sign"></i> Conclusion</h2>
                                ...
                                <h4>Loading data from Google servers</h4> Some countries have issues connecting to Google servers. This can cause issues loading Google Fonts from Google CDN. To resolve these issues please do the following:
                                <ol class="index-list">
                                    <li>Open <strong>app\design\frontend\TemplateMonster\Stormage\Magento_Theme\layout\default_head_blocks.xml</strong></li>
