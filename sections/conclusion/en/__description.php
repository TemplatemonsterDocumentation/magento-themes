<h2 class="item7"><i class="icon-question-sign"></i> Conclusion</h2>
        ...
        <p>The following resources will help you become a true Magento professional:</p>
        ...
        <ol class="index-list"> 
            ...
            <li>Find the line:<pre class="prettyprint">   &lt;link href='//fonts.googleapis.com/css?family=[---your_web_font_name_here---]' rel='stylesheet' type='text/css' /></pre></li> 
            <li>Replace it with the following piece of code: <br> 
