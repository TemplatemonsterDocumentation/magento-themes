...
<ol class="list-1">
	...
	<li>
		O módule permite incluir uma etiqueta para qualquer categoria.
		<figure class="img-polaroid"><img src="img/magento/mega-5.jpg" alt="" /></figure>
	</li>		
	<li>
		Você pode realizar esta inclusão no menu de categorias <strong>Catalog > Manage Categories</strong>.
		<figure class="img-polaroid"><img src="img/magento/mega-4.jpg" alt="" /></figure>
	</li>	
	<li>
		Para mudar a quantidade de colunas em subcategorias 
		<figure class="img-polaroid"><img src="img/magento/mega-7.jpg" alt="" /></figure>
		<p>você precisa mudar o valor de "Level column Count" no menu <strong>Catalog > Manage Categories</strong>.</p>
