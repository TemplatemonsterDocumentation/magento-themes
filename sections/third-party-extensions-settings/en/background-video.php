...
In order to implement background video you need to use <a href="https://github.com/pupunzi/jquery.mb.YTPlayer/wiki" target="_blank">jquery.mb.YTPlayer</a> plug-in, which allows to display YouTube video.Video can be added by means of the static block, including the script file <strong>jquery.mb.YTPlayer.js</strong> and by adding corresponding attributes set for the element which will display the video.
...
<table  class="options-table">
	<tr>
		...
		<td>-</td>
		<td>is a link for the video you want to display as a background one.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>-</td>
		<td>by default, “self” is  used to indicate block, which will contain video, if it is initialized in script.</td>
	</tr>
	<tr>
		<td class="col-1"><strong>opacity</strong></td>
		<td>-</td>
		<td> adjusts video transparence by values from 0 to 1.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>-</td>
		<td>determines the second on which the video will stop. </td>
	</tr>
	<tr>
