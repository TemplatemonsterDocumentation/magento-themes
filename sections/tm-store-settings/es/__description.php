...
<ol class="index-list">
    <li>Abra el paquete de la plantilla y vaya a la carpeta <strong>theme###</strong>.</li>
		<li>Suba el contenido de la carpeta <strong>theme###</strong> al directorio de instalaci&oacute;n de Magento (suba <i>"app"</i>, <i>"skin"</i> y otras carpetas). Estas carpetas contienen los archivos del tema. No van a afectar sus archivos existentes.</li>
</ol>
