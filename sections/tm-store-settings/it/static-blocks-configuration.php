...
<ol class="index-list"> 
	...
	<li>Clicca sul pulsante "Add New Block" nell'angolo a destra per aggiungere un nuovo blocco.<figure class="img-polaroid"><img src="img/magento/pages-setting-5.jpg" alt="" /></figure></li>
