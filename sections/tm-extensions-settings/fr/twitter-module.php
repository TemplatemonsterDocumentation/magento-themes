<h3>Module Twitter</h3>
	<p>Le module Twitter permet d'afficher les tweets en votre boutique.</p>						
	<p>Toutes les options de configuration sont disponibles via le panneau d'administration de Magento dans la section <strong>System > Configuration > Templatemonster > Twitter</strong>.</p>
	...
	Par défaut, le module est affiché dans la colonne de gauche. Mais il y a trois options d'affichage: <strong>gauche</strong>, <strong>droite</strong> et <strong>le pied de page</strong>. <br>
	Pour changer la position du bloc, vous devez ouvrir le fichier <strong>tm_twitter.xml</strong> situé dans le dossier <strong>app/design/frontend/default/themeXXX/layout</strong> de votre installation.<br>
...
&lt;reference name="right"&gt;
	&lt;block type="core/template" name="tm_twitter_timeline" as="tm_twitter_timeline" template="tm/twitter/twitter_timeline.phtml"/&gt;
&lt;/reference&gt; --&gt;</pre>
Les deux blocs sont commentés dans ce fichier. Et un seul bloc avec <strong>name="left"</strong> n'est pas commenté. Il affiche le module dans la colonne de gauche.<br>
