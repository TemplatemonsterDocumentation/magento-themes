...
Para mudar a posição do bloco, você deve abrir o arquivo <strong>tm_facebook.xml</strong> localizado em <strong>app/design/frontend/tm_themes/themeXXX/layout</strong>.</p>
