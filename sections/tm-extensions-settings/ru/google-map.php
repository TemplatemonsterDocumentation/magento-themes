<h3>Google Map</h3>
<p>Данный модуль позволяет вам вставить Google карту на вашем сайте Magento. По умолчанию, модуль предоставляет две карты: для страницы контактов и карту, которая отображается в футере других страниц.</p>						
<p>Обе карты можно настроить в админ панели Magento: <strong>System > Configuration > Templatemonster > Google Map</strong> секция.</p>
