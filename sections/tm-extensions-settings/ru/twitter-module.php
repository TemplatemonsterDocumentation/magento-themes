...
<p>Twitter модуль позволяет отобразить ленту твитов в вашем магазине.</p>						
<p>Все опции управления доступны в админ панели, в секции <strong>System > Configuration > Templatemonster > Twitter</strong>.</p>
...
По умолчанию, блок плагина выводится в левой колонке. Но существует три варианта вывода: <strong>слева</strong>, <strong>справа</strong> и в <strong>футере</strong>. <br>Для изменения позиции вывода блока необходимо открыть файл <strong>tm_twitter.xml</strong>, который находится в папке <strong>/app/design/frontend/default/themeXXX/layout</strong> вашей установки.<br>
...
&lt;reference name="right"&gt;
	&lt;block type="core/template" name="tm_twitter_timeline" as="tm_twitter_timeline" template="tm/twitter/twitter_timeline.phtml"/&gt;
&lt;/reference&gt; --&gt;</pre>
В этом файле закомментировано два блока. И лишь один блок с <strong>name="left"</strong> не закомментирован. Он и отвечает за вывод плагина в левой колонке. <br> Если же вам необходимо вывести плагин, к примеру, в футере, вам необходимо:
<ol>
