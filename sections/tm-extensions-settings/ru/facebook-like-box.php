...
<p>Данный модуль позволяет выводить Facebook like box в вашем Magento магазине.</p>						
Настроить его мы можете в админ панели Magento, в секции <strong>System > Configuration > Templatemonster > Facebook</strong>.
...
По умолчанию, блок плагина выводится в левой колонке. Но существует три варианта вывода: <strong>слева</strong>, <strong>справа</strong> и в <strong>футере</strong>.
Для изменения позиции вывода блока необходимо открыть файл <strong>tm_facebook.xml</strong>, который находится в папке <strong>app/design/frontend/default/themeXXX/layout</strong> вашей установки.
