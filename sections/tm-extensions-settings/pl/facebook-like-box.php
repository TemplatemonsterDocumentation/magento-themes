...
<p>Moduł jest wyświetlany domyślnie w lewej kolumnie. Jednak są trzy opcje wyświetlania: <strong>left</strong>, <strong>right</strong> oraz <strong>footer</strong>. <br>
	Aby zmienić położenie bloku, należy otworzyć plik <strong>tm_facebook.xml</strong> zlokalizowany w folderze <strong>app/design/frontend/tm_themes/themeXXX/layout</strong> Twojej instalacji.</p>
