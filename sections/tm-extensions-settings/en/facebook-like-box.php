...
<p>The given module allows to display Facebook like box on your Magento store.</p>						
You can configure it via Magento Admin Panel in <strong>System > Configuration > Templatemonster > Facebook</strong> section.
...
By default, the module is displayed in the left column. But there are three display options: <strong>left</strong>, <strong>right</strong> and <strong>footer</strong>.
