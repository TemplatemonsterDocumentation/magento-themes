...
<p>Then navigate to <strong>TemplateMonster > Ajax Catalog </strong> in the left side menu to go to the module settings interface.</p>
<figure class="img-polaroid"><img src="img/magento/ajaxcatalog.png" alt="" /></figure>		
<p>Let’s review module options:</p>
<table  class="options-table">
	<tr>
		<td class="col-1"><strong>Ajax Filter</strong></td>
		<td>-</td>
	...
	<tr>
		...
		<td>-</td>
		<td><div align="justify">products display layout. This option allows you to specify products layout for listing pages without reloading them.Use ajax filter for view mode switcher.(1)</div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>-</td>
		<td>products ordering. 	 Use ajax filter for 'sort by' switcher.You can sort items without reloading the main page.(2)</td>
	</tr>		
	<tr>
		<td class="col-1"><strong>Pagination</strong></td>
		<td>-</td>
		<td><div align="justify">listing pagination. If your listing includes more than one page with products, this option allows you to switch between the inner pages without reloading the main page.(3)</div></td>
	</tr>		
	<tr>
		<td class="col-1"><strong>Items per page</strong></td>
		<td>-</td>
		<td><div align="justify"> use ajax filter for 'items per page' switcher.(4)</div></td>
	</tr>
    <tr>
		<td class="col-1"><strong>Price slider</strong></td>
		<td>-</td>
		<td> show price slider in place of default two fields price range. (5)</td>
	</tr>		
	<tr>
    ...
    <tr>
		...
		<td>-</td>
		<td>choose attributes for layer navigation multiselect.(6)</td>
	</tr>		
</table>
 <h4>Frontend:</h4>
<figure class="img-polaroid"><img src="img/magento/ajaxcatalog-3.jpg" alt="" /></figure>
    <ol class="marked-list">
  <li><strong>View Mode(Grid/List) </strong>(1) — Enabled;</li>
  <li><strong>Sort By(DESC/ASC) </strong>(2)<strong> — </strong>Enabled;</li>
  <li><strong>Pagination</strong> (3) — <strong> </strong>Enabled;</li>
  <li><strong>Items per page </strong>(4) — Enabled;</li>
  <li><strong>Price slider </strong> (5) — Enabled;</li>
  <li><strong>Product Attributes</strong> (6) — Brand, Design, Themes, Color, Size.</li>
</ol>
