<h2 class="item1">Mega Menu</h2>
<p class="indent">TemplateMonster <strong>Mega Menu</strong> module expands standard Magento menu functionalities and allows setting the menu to display the subcategories in multiple columns. It also provides the possibility to add static blocks and products to the list of the dropdown menu, as well as the flexible customization of site admin panel.</p>
...
Then choose the <strong>TEMPLATEMONSTER > Megamenu</strong> in the left side menu and you'll move to the module settings interface. 
...
You will see the <strong>Enable Megamenu for this Category</strong> option at the <strong>MegaMenu tab</strong>. This option turns on Megamenu block display for the selected category. After enabling this option, you will see the two fields and a widget with menu content settings.
...
<p>The Catalog New Products List widget allows you to add a list of products to a page; here you can select the amount of products that you want to show and if you want to display only new products or all products.<p>
<figure class="img-polaroid"><img src="img/magento/cnpl.png" alt="" /></figure>


<strong> — Catalog Product Link </strong>
...
<p>To display a list of products on your page, you can use the Catalog Product List widget. With this widget, you can control the products shown based on your own conditions(product attributes).</p>
...
<figure class="img-polaroid"><img src="img/magento/rvp.png" alt="" /></figure>


    <li>
        <strong>Selected items</strong> - the field for sorting the items. It allows you to change the display  order (sorting) of your column content. Drag&Drop interface allows  reordering items by dragging them. If you do not want the product or static block to be displayed below, just drag it to the top to reach the required appearance. You can also remove some items here. Select the ones you need to remove and press on <strong>Remove selected</strong> button to do that.
        <figure class="img-polaroid"><img src="img/magento/menu-10.png" alt="" /></figure>
    </li>

<li> <strong>Add video</strong> - this video extension allows you to add videos to your product pages. You can upload a video (FLV, MPEG, MP4, JPEG, PNG, GIF and SWF) or embed it from YouTube or Vimeo. 
    </li>
