<h3 align="justify">Megamenu</h3>
                                <p align="justify" class="indent">TemplateMonster Megamenu module extends standard Magento menu functionality and allows you to configure subcategories multi-column display, add static blocks and products to the dropdown menu, as well as the flexibly customize its appearance in site admin panel.Favicon image Will be scaled down to 32 x 32px</p>
<p>
   <figure class="img-polaroid"><img src="img/magento/mega-3.png" alt="" /></figure>
</p>
...
<ul class="marked-list">
  ...
  <p><strong>— CMS Static Block</strong>
  </p>
  ...
  <p><strong> — Catalog Category Link </strong>
  </p>
  ...
  <p><strong>— Catalog New Products List </strong>
  </p>
  ...
  <p><strong>— Catalog Product Link </strong> </p>
  ...
  <p><strong>— Catalog Product List</strong>
  </p>
  ...
  <p><strong>— Orders and Returns</strong>
  </p>
  ...
  <p><strong> — Recently Compared Products</strong>
  </p>
  ...
  <p><strong>— Recently Viewed Products</strong>
  </p>
