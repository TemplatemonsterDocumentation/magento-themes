<h3>Twitter module</h3>
	<p>Twitter module allows to display tweets feed on your store.</p>						
	<p>All configuration options are available in admin panel in <strong>System > Configuration > Templatemonster > Twitter</strong> section.</p>
	...
	By default, the block is displayed in the left column. But there are three display options: <strong>left</strong>, <strong>right</strong> and <strong>footer</strong>. <br>
		In order to change the position of block, you need to open <strong>tm_twitter.xml</strong> file located in the <strong>/app/design/frontend/default/themeXXX/layout</strong> folder of your installation.<br>
...
&lt;block type="core/template" name="tm_twitter_timeline" as="tm_twitter_timeline" template="tm/twitter/twitter_timeline.phtml"/&gt;
&lt;/reference&gt; --&gt;</pre>
Two blocks are commented out in this file. And only one block with <strong>name="left"</strong> is not commented out. It displays the block in the left column. <br>
