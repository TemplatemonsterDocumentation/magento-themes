<h3>Film Slider</h3>
<p align="justify">TemplateMonster <strong>FilmSlider</strong> module is an implementation of elegant and professional jQuery plugin 'Slider Pro'. Allows you to add slider with multiple layers to your store home page. Rich collection of slider configuration options and user interface will help you to configure your slider fast and easily.</p>
...
<p align="justify">To add new slider click <strong>Add New Slider</strong> button in the top right corner. <br>
...
<p align="justify">In image section you can adjust slider image configuration settings. Each option has a brief description. Let's describe some of them more specifically.</p>
<figure class="img-polaroid"><img src="img/magento/slide-5.png" alt="" /></figure>
<h5>The Aspect Ratio</h5>
<div align="justify">Sets the aspect ratio of the slides. If set to a value different than -1, the height of the slides will be overridden in order to maintain the specified aspect ratio. </div>
<h5>Image Scale Mode</h5>
<div align="justify">
...
<p>This section contains settings for fade animation. Fade animation can be enabled on slide switch.
  <figure class="img-polaroid"><img src="img/magento/slide-7.png" alt="" /></figure>
</p>
<p>You can set if you want to fade out previous slide and fade animation duration in milliseconds. </p>
<h5>Auto play settings</h5>
<p align="justify">Autoplay feature in Film Slider allows looping through the slides automatically. This configuration settings contain options to configure auto play delay, direction and pause with mouse cursor on hover.
</p>
<p>
...
<p align="justify">Slider controls are the navigation buttons that let you switch the slides. In <strong>FilmSlider</strong> there are several types of navigation controls: <strong>prev/next</strong> arrows,  <strong>pagination</strong> buttons. Enabled keyboard navigation allows you to switch between the slides using keyboard. Also, you can enable button that will switch slider to the full screen mode.</p>
<p>
  <figure class="img-polaroid"><img src="img/magento/slide-9.png" alt="" /></figure>
  
</p>
<h5>Responsive settings</h5>
<div align="justify">Responsive settings section configures slider behaviour on mobile devices. Here you can define screen width breakpoints [<strong>small, medium, large</strong>]. Also, you can enable touch swipe behaviour to let user switch between the slides with swipe gestures. 
</div>
<figure class="img-polaroid">
  <p><img src="img/magento/slide-10.png" alt="" /></p>
</figure>
...
<h4>Adding Slides</h4>
<p align="justify">You can add new slides only after saving the slider. Click <strong>Save and Continue Edit</strong> button in the top right corner. When the slider is saved, switch to <strong>Slider Items</strong> tab.</p>
<p>
...
<p align="justify">Under the Image field you can see your slide preview. You are free to set preview size the way you like. We moved the next section of slide configuration to the separate section as it is fully related to slide layers. </p>
<h4>Working with layers</h4>
<div align="justify"><strong>FilmSlider</strong> is a multi-layer slider. This mean that you can add multiple independent layers to your slide. Layers can be added to the slide on the slide configuration screen described above. This screen contains several sections of layers settings.
  
</div>
<h5>Layers list</h5>
<p align="justify">Layers list section allows you to add layers to your slide. You can add image layers and text layers. Use corresponding buttons to add layers.
</p>
<p>
  <figure class="img-polaroid"><img src="img/magento/slide-17.png" alt="" /></figure>
</p>
<p align="justify">By clicking on <strong>Add layer image</strong> you'll see an image library where you can select from available images or upload images from your computer. By clicking <strong>Add layer text</strong>, you'll see new text layer added and layer settings became associated with your new particular layer.</p>
<p>
