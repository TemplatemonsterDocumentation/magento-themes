...
<p align="justify">When you are done with uploading files, you can start Magento engine installation process. Open your browser and in the address bar type your <strong>'domain name/path to your Magento directory'</strong>. You should see the welcome screen. Please follow the instructions below to install Magento. </p>
...
<p align="justify">Select the required time zone, default currency and store language. In the <strong>Advanced Modules Configurations</strong> section you can also select default modules that should/shouldn't be installed. We recommend that you do not perform changes in this section. </p>
