...
<p align="justify" class="alert alert-warning"><span>Please make sure to set the correct permissions for the directory where you are planning to extract the files. Permissions should be <strong>CHMOD 755 or 777</strong> depending on your server configuration. </span></p>
